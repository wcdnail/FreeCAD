macro(InitializeFreeCADBuildOptions)
    ...
    if(MSVC)
        ...
        if (EXISTS ${FREECAD_LIBPACK_DIR}/plugins/imageformats/qsvg.dll)
            ...
            option(FREECAD_INSTALL_DEPEND_DIRS "Create install dependency commands for the INSTALL target found in the FreeCAD solution." ON)
            ...
            # message(STATUS "Could not locate ${FREECAD_LIBPACK_DIR}/plugins/imageformats/qsvg.dll")
